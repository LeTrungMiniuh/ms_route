...
import com.ticketsystem.route.service.StaffQueryService;
import com.ticketsystem.route.service.StaffService;
import com.ticketsystem.route.service.criteria.StaffCriteria;
...
/**
 * REST controller for managing {@link com.ticketsystem.route.domain.Staff}.
 */
@RestController
...
public class StaffResource {
    ...
    private static final String ENTITY_NAME = "msRouteStaff";
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<StaffDTO>> getAllStaff(StaffCriteria criteria) {
        LOG.debug("REST request to get Staff by criteria: {}", criteria);

        List<StaffDTO> entityList = staffQueryService.findByCriteria(criteria);
