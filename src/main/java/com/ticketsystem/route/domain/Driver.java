...
public class Driver implements Serializable {
    ...
    public Driver licenseClass(String licenseClass) {
        this.setLicenseClass(licenseClass);
        return this;
    }
    ...
    public Driver yearsExperience(Integer yearsExperience) {
    ...
    public Driver isDeleted(Boolean isDeleted) {
    ...
    public Driver deletedAt(Instant deletedAt) {
    ...
    public Driver deletedBy(UUID deletedBy) {
